...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=================무게가 100그램 이하인 사과만 필터링======================");
        ...
        System.out.println("=============무게가 100그램보다 큰 사과만 필터링====================");
        ...
        filter(appleList,a -> a.getColor()==RED);
        ...
        System.out.println("=============색상만 추출===============");

        //사과 리스트에서 사과의 색상만 추출하여 새로운 색상리스트를 반환
//        List<Color> colorList = map(appleList, new GenericFunction<Apple, Color>() {
//            @Override
